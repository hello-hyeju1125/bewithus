...
const sessionCtaClass = cn(
  "inline-flex items-center justify-center gap-2 rounded-button px-7 py-3.5 text-[19px] font-bold outline-none transition-colors duration-200 focus-visible:ring-2 sm:text-[20px]",
        ...
        >
          ...
          >
            ...
            <header className="mt-5 flex flex-wrap items-center justify-between gap-3 border-b border-neutral-200 pb-5">
              <p className="inline-flex items-center gap-1.5 text-[16px] text-neutral-500 sm:text-[18px]">
              ...
              {upcoming ? (
                ...
                <span className="text-[17px] font-semibold text-neutral-400">
                  종료된 설명회
                </span>
              )}
            </header>
            ...
            {safeHtml ? (
              ...
              <p className="mt-8 whitespace-pre-line text-[18px] leading-relaxed text-neutral-800 sm:text-[22px]">
                {session.description}
              </p>
            ) : null}
